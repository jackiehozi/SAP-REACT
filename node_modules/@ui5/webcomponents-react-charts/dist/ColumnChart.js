...
import { BarChart, CartesianGrid, XAxis, YAxis, Bar, LabelList, Cell, Legend, ReferenceLine, Label, Tooltip, Brush } from 'recharts';
...
var ColumnChart = /*#__PURE__*/forwardRef(function (props, ref) {
  var _chartConfig$secondYA, _ref3, _chartConfig$secondYA3, _chartConfig$secondYA4, _chartConfig$secondYA5, _chartConfig$secondYA6;
  ...
  var isBigDataSet = (_ref3 = (dataset === null || dataset === void 0 ? void 0 : dataset.length) > 30) !== null && _ref3 !== void 0 ? _ref3 : false;
  ...
  return /*#__PURE__*/React.createElement(ChartContainer, _extends({
    dataset: dataset,
    loading: loading,
    Placeholder: ChartPlaceholder !== null && ChartPlaceholder !== void 0 ? ChartPlaceholder : ColumnChartPlaceholder,
    ref: chartRef,
    style: style,
    className: className,
    tooltip: tooltip,
  ...
  }, passThroughProps), /*#__PURE__*/React.createElement(BarChart, {
    syncId: syncId,
    ...
    var _chartConfig$secondYA7, _element$label, _element$color, _element$color2;
