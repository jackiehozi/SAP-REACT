...
import { LineChart as LineChart$1, CartesianGrid, XAxis, YAxis, Line, Legend, ReferenceLine, Label, Tooltip, Brush } from 'recharts';
...
var LineChart = /*#__PURE__*/forwardRef(function (props, ref) {
  var _chartConfig$secondYA, _ref2, _chartConfig$secondYA3, _chartConfig$secondYA4, _chartConfig$secondYA5, _chartConfig$secondYA6;
  ...
  var preventOnClickCall = useRef(0);
  ...
  return /*#__PURE__*/React.createElement(ChartContainer, _extends({
    dataset: dataset,
    loading: loading,
    Placeholder: ChartPlaceholder !== null && ChartPlaceholder !== void 0 ? ChartPlaceholder : LineChartPlaceholder,
    ref: chartRef,
    style: style,
    className: className,
    tooltip: tooltip,
  ...
  }, passThroughProps), /*#__PURE__*/React.createElement(LineChart$1, {
    syncId: syncId,
    margin: marginChart,
    data: dataset,
    ...
    interval: 0,
    tick: chartConfig.yAxisTicksVisible && /*#__PURE__*/React.createElement(YAxisTicks, {
      config: primaryMeasure
    }),
    width: yAxisWidth
  }), ((_chartConfig$secondYA3 = chartConfig.secondYAxis) === null || _chartConfig$secondYA3 === void 0 ? void 0 : _chartConfig$secondYA3.dataKey) && /*#__PURE__*/React.createElement(YAxis, {
    ...
    var _element$showDot, _chartConfig$secondYA7, _element$label, _element$color;

    return /*#__PURE__*/React.createElement(Line, {
      dot: (_element$showDot = element.showDot) !== null && _element$showDot !== void 0 ? _element$showDot : !isBigDataSet,
      yAxisId: ((_chartConfig$secondYA7 = chartConfig.secondYAxis) === null || _chartConfig$secondYA7 === void 0 ? void 0 : _chartConfig$secondYA7.dataKey) === element.accessor ? 'right' : 'left',
      key: element.accessor,
      name: (_element$label = element.label) !== null && _element$label !== void 0 ? _element$label : element.accessor,
      strokeOpacity: element.opacity // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
      ,
